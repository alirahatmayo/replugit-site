      ...
      <section className="relative py-24 px-6 bg-gradient-to-br from-emerald-900 via-emerald-800 to-slate-900">
        <div className="max-w-6xl mx-auto text-center text-white">
          ...
          <p className="text-xl md:text-2xl text-slate-300 max-w-4xl mx-auto leading-relaxed mb-12">
            Your trusted wholesale partner for bulk electronics. Serving retailers, resellers, and enterprises with competitive pricing and reliable supply.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <a href="mailto:wholesale@replugit.com" className="bg-emerald-600 hover:bg-emerald-700 text-white px-10 py-4 text-lg font-semibold rounded-xl shadow-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-3">
              <Mail className="w-5 h-5" />
              Email for Wholesale Pricing
            </a>
            <a href="https://chat.whatsapp.com/KdPqKlFB1eS6AO3I5mConi" target="_blank" rel="noopener noreferrer" className="border-2 border-white/30 text-white hover:bg-white/10 px-10 py-4 text-lg font-semibold rounded-xl backdrop-blur-sm transition-all duration-300 flex items-center justify-center gap-3">
