...
export default function HeroBanner({ src: srcProp }: HeroBannerProps) {
  ...
  return (
    <div className="px-6 sm:px-8 md:px-12 lg:px-16 my-6">
      <div className="relative w-full h-[80vh] min-h-[600px] overflow-hidden bg-slate-900 rounded-3xl shadow-2xl max-w-7xl mx-auto">
      ...
      <div className="relative z-10 flex items-center justify-center h-full px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          {/* Main heading */}
          <h1 className={`text-5xl md:text-7xl lg:text-8xl font-bold mb-8 leading-tight transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className={`flex flex-col sm:flex-row gap-6 justify-center items-center mb-16 transition-all duration-1000 delay-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <button 
              ...
              className="group bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-10 py-5 text-lg font-semibold rounded-xl shadow-2xl hover:shadow-green-500/25 transition-all duration-300 transform hover:scale-105 cursor-pointer"
            >
            ...
            <button 
              ...
              className="group border-2 border-white/30 hover:border-white/60 text-white hover:bg-white/10 px-10 py-5 text-lg font-semibold rounded-xl backdrop-blur-sm transition-all duration-300 cursor-pointer"
            >
              <span className="flex items-center gap-3">
                Explore Services
